...
- dragndrop_div_class - custom CSS class of the component's outermost div
    ...
    option_spec.update({"feedback":directives.unchanged,
        ...
        "match_01":directives.unchanged,
        "match_02":directives.unchanged,
        "match_03":directives.unchanged,
        "match_04":directives.unchanged,
        "match_05":directives.unchanged,
        "match_06":directives.unchanged,
        "match_07":directives.unchanged,
        "match_08":directives.unchanged,
        "match_09":directives.unchanged,
